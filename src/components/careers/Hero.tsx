...
export default function Hero() {
  return (
    <section className="w-screen h-[40vh] text-black flex flex-col md:flex-row items-center gap-8 px-8 lg:px-32 justify-center lg:justify-between">
      <div className="flex flex-col gap-8">
        <h1 className="text-4xl lg:text-6xl">Careers</h1>
        <p className="text-sm lg:text-base break-normal w-[80vw]">
          At this stage we have wonderful people contributing to saha. Please
          feel free to send us a copy of your CV to{" "}
          <u>satyamsaha.ca@gmail.com</u> and we will be in touch.
        </p>
      </div>
    </section>
